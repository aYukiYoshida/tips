...
￼
<div align="center">
<img src="/assets/statistics/significance_figure1.png" width="50%"/>
</div>
...
<div align="center">
<img src="/assets/statistics/significance_figure2.png" width="100%"/>
</div>
...
* $p=0.01$という値は、帰無仮説が正しいときに、帰無仮説を棄却する確率が0.01であるということである。言い換えると「差がない」という仮定の下で「差がある」という結論が得られる確率は非常に小さなものである、ということである。  
